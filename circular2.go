...
const (
	QueueCount    = 1000 // Number of circular queues
	QueueSize     = 1    // Size of each circular queue
	ConsumerCount = 1000 // Number of consumers
	DataCount     = 1000 // Total data items to produce
)
...
// Total execution time : 14.603041ms
